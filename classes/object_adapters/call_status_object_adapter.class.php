...
class CallStatusObjectAdapter extends ObjectAdapter implements ObjectManipInterface  {
     ...
     function __construct($table_name, $class_name)    {
        ...
        $this->fields_prev_text_array = array("id"=>"ID","call_status_name"=>"Наименование статуса");
        $this->fields_width_array = array("id"=>10,"call_status_name"=>25);
        $this->select_display_field = "call_status_name";
        $this->manip_form_template = "<table><tr><td>***___call_status_name</td><td>***___code</td><td>***___id</td></tr>
            </table>";
     ...
     function writeTableRow($object, $linked_props)    {
        ...
        parent::write_td($object->call_status_name,75);
