...
class TeamTypeObjectAdapter extends ObjectAdapter implements ObjectManipInterface  {
     ...
     function __construct($table_name, $class_name)    {
        ...
        $this->fields_prev_text_array = array("id"=>"ID","team_type_name"=>"Наименование задачи");
        $this->fields_width_array = array("id"=>10,"team_type_name"=>25);
        $this->select_display_field = "team_type_name";
        $this->manip_form_template = "<table><tr><td>***___team_type_name</td><td>***___code</td><td>***___id</td></tr>
            </table>";
